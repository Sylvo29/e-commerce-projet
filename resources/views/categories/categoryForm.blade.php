    ...
    <div class="col-md-8">
        ...
        <div class="form-check form-switch">
            <input name="isFoot" id="isFoot" value="true" data-bs-toggle="toggle"  {{ old('isFoot', isset($category) && $category->isFoot == 'true' ? 'checked' : '') }} class="form-check-input" type="checkbox" role="switch" />
        </div>
        {{-- <select class="form-control" name="isFoot" id="isFoot">
            <option value="true" {{ old('isFoot', isset($category) && $category->isFoot == 'true' ? 'selected' : '') }}>Yes</option>
            <option value="false" {{ old('isFoot', isset($category) && $category->isFoot == 'false' ? 'selected' : '') }}>No</option>
        </select> --}}
