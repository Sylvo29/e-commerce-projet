...
<div class="">
    ...
    <div class="form-check form-switch">
        <input name="isMega" id="isMega" data-id="{{$category->id}}" value="true" data-bs-toggle="toggle"  {{ isset($category) && $category->isMega == 'true' ? 'checked' : '' }} class="form-check-input" type="checkbox" role="switch" />
							    ...
							    <td>
    <div class="form-check form-switch">
        <input name="isFoot" id="isFoot" data-id="{{$category->id}}" value="true" data-bs-toggle="toggle"  {{ isset($category) && $category->isFoot == 'true' ? 'checked' : '' }} class="form-check-input" type="checkbox" role="switch" />
    </div>
</td>
						<td>
