    ...
    <div class="col-md-8">
        ...
        <label for="prod_private_key" class="form-label">Prod_private_key</label>
        <input type="text"  placeholder="Prod_private_key ..."  name="prod_private_key" value="{{ old('prod_private_key', isset($method) ? $method->prod_private_key : '') }}" class="form-control" id="prod_private_key" aria-describedby="prod_private_keyHelp" required/>

        @error('prod_private_key')
            <div class="error text-danger">
                {{ $message }}
            </div>
        @enderror
        ...
        <div class="form-check form-switch">
            <input name="isAvailable" id="isAvailable" value="true" data-bs-toggle="toggle"  {{ old('isAvailable', isset($method) && $method->isAvailable == 'true' ? 'checked' : '') }} class="form-check-input" type="checkbox" role="switch" />
        </div>
        {{-- <select class="form-control" name="isAvailable" id="isAvailable">
            <option value="true" {{ old('isAvailable', isset($method) && $method->isAvailable == 'true' ? 'selected' : '') }}>Yes</option>
            <option value="false" {{ old('isAvailable', isset($method) && $method->isAvailable == 'false' ? 'selected' : '') }}>No</option>
        </select> --}}
