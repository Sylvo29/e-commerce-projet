    ...
    <tr>
        ...
        <td>
            <div class="form-check form-switch">
                <input name="isAvailable" disabled id="isAvailable" value="true" data-bs-toggle="toggle"  {{ $method->isAvailable == 'true' ? 'checked' : '' }} class="form-check-input" type="checkbox" role="switch" />
            </div>
        </td>
    </tr>
