...
<div class="">
    ...
    <div class="form-check form-switch">
        <input name="isFoot" id="isFoot" data-id="{{$page->id}}" value="true" data-bs-toggle="toggle"  {{ isset($page) && $page->isFoot == 'true' ? 'checked' : '' }} class="form-check-input" type="checkbox" role="switch" />
							    ...
							    <td>
    <div class="form-check form-switch">
        <input name="isCheckout" id="isCheckout" data-id="{{$page->id}}" value="true" data-bs-toggle="toggle"  {{ isset($page) && $page->isCheckout == 'true' ? 'checked' : '' }} class="form-check-input" type="checkbox" role="switch" />
    </div>
</td>
						<td>
