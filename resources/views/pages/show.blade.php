...
@section('content')
    ...
    <tr>
        ...
        <td>
            <div class="form-check form-switch">
                <input name="isCheckout" disabled id="isCheckout" value="true" data-bs-toggle="toggle"  {{ $page->isCheckout == 'true' ? 'checked' : '' }} class="form-check-input" type="checkbox" role="switch" />
            </div>
        </td>
    </tr>
