        ...
        <div class="col-md-8">
            <form
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" name="categories[]" id="categories" multiple>
                        <option disabled value="null" >Please, select product categories</option>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" name="tags[]" id="tags" multiple>
                        <option disabled value="null" >Please, select product tags</option>
                        @foreach ($tags as $tag)
                        <option value="{{$tag->id}}"
                            value="{{$tag->id}}"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" placeholder="SoldePrice ..." name="soldePrice"
                        value="{{ old('soldePrice', isset($product) ? $product->soldePrice : '') }}"
                        class="form-control" id="soldePrice" aria-describedby="soldePriceHelp" required />
                ...
                <div class="mb-3">
                    ...
                    <input type="text" placeholder="RegularPrice ..." name="regularPrice"
                ...
                <div class="mb-3 d-flex gap-2">
                    ...
                    <div class="form-check form-switch">
                        <input name="isAvailable" id="isAvailable" value="true" data-bs-toggle="toggle"
                            {{ old('isAvailable', isset($product) && $product->isAvailable == 'true' ? 'checked' : '') }}
            ...
            <option value="false" {{ old('isAvailable', isset($product) && $product->isAvailable == 'false' ? 'selected' : '') }}>No</option>
                ...
                <div class="mb-3 d-flex gap-2">
                    ...
                    <div class="form-check form-switch">
                        <input name="isBestSeller" id="isBestSeller" value="true" data-bs-toggle="toggle"
                            {{ old('isBestSeller', isset($product) && $product->isBestSeller == 'true' ? 'checked' : '') }}
                            class="form-check-input" type="checkbox" role="switch" />
                    </div>
            ...
            <option value="false" {{ old('isBestSeller', isset($product) && $product->isBestSeller == 'false' ? 'selected' : '') }}>No</option>
                ...
                <div class="mb-3 d-flex gap-2">
                    ...
                    <div class="form-check form-switch">
                        <input name="isNewArrival" id="isNewArrival" value="true" data-bs-toggle="toggle"
                            {{ old('isNewArrival', isset($product) && $product->isNewArrival == 'true' ? 'checked' : '') }}
                            class="form-check-input" type="checkbox" role="switch" />
                    </div>
            ...
            <option value="false" {{ old('isNewArrival', isset($product) && $product->isNewArrival == 'false' ? 'selected' : '') }}>No</option>
                ...
                <div class="mb-3 d-flex gap-2">
                    ...
                    <div class="form-check form-switch">
                        <input name="isFeatured" id="isFeatured" value="true" data-bs-toggle="toggle"
                            {{ old('isFeatured', isset($product) && $product->isFeatured == 'true' ? 'checked' : '') }}
                            class="form-check-input" type="checkbox" role="switch" />
                    </div>
            ...
            <option value="false" {{ old('isFeatured', isset($product) && $product->isFeatured == 'false' ? 'selected' : '') }}>No</option>
                ...
                <div class="mb-3 d-flex gap-2">
                    ...
                    <div class="form-check form-switch">
                        <input name="isSpecialOffer" id="isSpecialOffer" value="true" data-bs-toggle="toggle"
                            {{ old('isSpecialOffer', isset($product) && $product->isSpecialOffer == 'true' ? 'checked' : '') }}
                            class="form-check-input" type="checkbox" role="switch" />
                    </div>
